...
fn compute_aggregate_kzg_proof_bench_(c: &mut Criterion) {
...
fn verify_aggregate_kzg_proof_bench_(c: &mut Criterion) {
    assert!(init(CurveType::BLS12_381));
...
criterion_group! {
    ...
    targets = compute_aggregate_kzg_proof_bench_, verify_aggregate_kzg_proof_bench_
}
